...
function txt() {
    var t = "Vanguard".split("").join(String.fromCharCode(0x2004));
    context.font = "min(9vw, 4em) nexa_boldregular";
    context.fillStyle = 'hsl(354, 68%, 40%)';
    context.fillText(t, (c.width - context.measureText(t).width) * 0.5, c.height * 0.5);
}

function draw() {
    context.fillStyle = '#000501';
...
function conn(p1, p2) {
    context.strokeStyle = 'hsl(354, 68%, 40%)';
    var dist = _dist(p1, p2);
    context.globalAlpha = 1 - dist / 100;
    context.beginPath();
